...
async def send_to_pi(message: dict):
    disconnected = []
...
async def disconnect_client(websocket: WebSocket, client_type: str):
    ...
    elif client_type == "pi" and websocket in pi_clients:   
